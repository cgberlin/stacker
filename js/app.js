...
var getTop = function(topResults){
	var request = {
		tagged : topResults,
		order : 'desc',
		sort : 'creation'
	...
	$.ajax({
		url : "https://api.stackexchange.com/2.2/tags/" + request.tagged + "/top-answerers/all_time?site=stackoverflow",
		data : request,
		dataType : "jsonp",
		type : "GET",
	})
...
$(document).ready( function() {
	...
	$('.inspiration-getter').submit(function(e){
		e.preventDefault();
		$('.results').html('');
		var topResults = $(this).find("input[name='answerers']").val();
